...
class _migrate extends \IPS\Dispatcher\Controller
{
    ...
    protected function manage()
    {
        ...
        $form->add(new Form\Text('api_url', 'https://api.perscom.io/v1', true));
        $form->add(new Form\Text('api_key', null, true, [], null, null, '<span class="ipsFieldRow_desc">Create a new API key on your PERSCOM dashboard, under "System" > "API" > "Keys". <strong>Remember to add all scopes!</strong></span>'));
        $form->add(new Form\Text('perscom_id', null, true, [], null, null, '<span class="ipsFieldRow_desc">Can be found on your PERSCOM dashboard, under "System" > "Settings".</span>'));

        $form->addHeader('perscommigrator__migrate_personnel_filter');
        $form->add(new Form\Node('status_blacklist', null, true, [
        ...
        $result = $migrator->migrate([
            'status' => $values['status_blacklist'],
        ]);
